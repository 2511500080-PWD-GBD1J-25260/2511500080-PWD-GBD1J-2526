...
<body>
  ...
  <main>
    ...
    <?php
    /* Ambil flash message dan old value untuk form biodata */
    ...
    <section id="biodata">
      ...
      <!-- Flash message sukses untuk biodata -->
      ...
      <!-- Flash message error untuk biodata -->
      ...
      <!-- Link ke halaman pembaca biodata -->
      <p style="margin-top:15px;"><a href="read_biodata.php" style="color:#003366;">Lihat Data Biodata Pengunjung →</a></p>
    </section>
