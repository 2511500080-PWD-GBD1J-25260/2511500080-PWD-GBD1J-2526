...
<body>
  ...
  <main>
    ...
    <section id="biodata">
      ...
      <form action="proses.php" method="POST">
        ...
        <label for="txtNmLengkap"><span>Nama Lengkap:</span>
          <input type="text" id="txtNmLengkap" name="txtNmLengkap" placeholder="Masukkan Nama Lengkap" required
            value="<?= isset($old_biodata['nama_lengkap']) ? htmlspecialchars($old_biodata['nama_lengkap']) : '' ?>">
        </label>

        <label for="txtT4Lhr"><span>Tempat Lahir:</span>
          <input type="text" id="txtT4Lhr" name="txtT4Lhr" placeholder="Masukkan Tempat Lahir" required
            value="<?= isset($old_biodata['tempat_lahir']) ? htmlspecialchars($old_biodata['tempat_lahir']) : '' ?>">
        </label>

        <label for="txtTglLhr"><span>Tanggal Lahir:</span>
          <input type="date" id="txtTglLhr" name="txtTglLhr" placeholder="Masukkan Tanggal Lahir" required
            value="<?= isset($old_biodata['tanggal_lahir']) ? htmlspecialchars($old_biodata['tanggal_lahir']) : '' ?>">
        </label>
        ...
        <label for="txtKerja"><span>Pekerjaan:</span>
          <input type="text" id="txtKerja" name="txtKerja" placeholder="Masukkan Pekerjaan" required
            value="<?= isset($old_biodata['pekerjaan']) ? htmlspecialchars($old_biodata['pekerjaan']) : '' ?>">
        </label>

        <label for="txtNmOrtu"><span>Nama Orang Tua:</span>
          <input type="text" id="txtNmOrtu" name="txtNmOrtu" placeholder="Masukkan Nama Orang Tua" required
            value="<?= isset($old_biodata['nama_ortu']) ? htmlspecialchars($old_biodata['nama_ortu']) : '' ?>">
        </label>

        <label for="txtNmKakak"><span>Nama Kakak:</span>
          <input type="text" id="txtNmKakak" name="txtNmKakak" placeholder="Masukkan Nama Kakak" required
            value="<?= isset($old_biodata['nama_kakak']) ? htmlspecialchars($old_biodata['nama_kakak']) : '' ?>">
        </label>

        <label for="txtNmAdik"><span>Nama Adik:</span>
          <input type="text" id="txtNmAdik" name="txtNmAdik" placeholder="Masukkan Nama Adik" required
            value="<?= isset($old_biodata['nama_adik']) ? htmlspecialchars($old_biodata['nama_adik']) : '' ?>">
        </label>
      ...
      <?php include 'read_mahasiswa.php'; ?>
    </section>
